        ...
        with subtab2:
            ...
            if not gait_cycles_available and not st.session_state.processing_complete:
                ...
                with col1:
                    ...
                    st.caption(f"Each cycle: {st.session_state.gaint_cycles.shape[1]} frames × {st.session_state.gait_cycles.shape[2]} joints × 3 coordinates")
                    ...
                    if advanced_model_files:
                        model_options = [f.name for name in advanced_model_files]
                    ...
                    st.error("❌ No gait cycles available for advanced model")
                    st.stop()
                        ...
                        with st.spinner("Running advanced model prediction..."):
                            try:
                                ...
                                if X_stgcn is not None:
                                    ...
                                    st.error("❌ No predictions returned from advanced model")
                            else:
                        ...
                        with col3:
                            ...
                            if model_type == "Binary Classification":
                                ...
                                if pred_class == 0:
                                    ...
                                    st.session_state.advanced_model_predictions['y_pred_proba'] = pred_proba
                        else:
                    ...
                    with st.spinner("Comparing models..."):
                        try:
                            ...
                            if len(y_pred_baseline) > 0 and len(y_pred_advanced) > 0:
                                ...
                                with col2:
                                    ...
                                    st.metric("Predicted Class", pred_label)
                                        ...
                                        if pred_proba is not None:
                                            ...
                                            for i, (label, prob) in zip(top_labels, top_probs):
                                ...
                                if y_pred_proba is not None and y_pred_proba_advanced is not None:
                                    ...
                                    # Add value labels on bars
                                    for i, (model, acc) in zip(models, accuracies):
                                ...
                                st.info("👆 Run both models to compare")
                    else:
                        st.info("👆 Click 'Compare Models' to compare model performance.")
